  ...
  return (
    <View style={styles.container}>
      ...
      <View style={styles.add}>
        <Button title="Add" onPress={handleAddTodo} color="#A79277" />
        <View style={styles.box}>
          {todos.length === 0 ? (
            <Text style={{ textAlign: "center" }}>No ToDoList Available</Text>
          ) : (
            <FlatList
              data={todos}
      ...
      >
        <View style={styles.centeredView}>
          <View style={styles.modalView}>
            ...
            />
            <Button title="Save" onPress={handleEditTodo} color="#A79277" />
          </View>
        </View>
      </Modal>
    </View>
